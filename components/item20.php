...
<body>
    ...
    <main>
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="20">
                    <div class="img-con">
                        <img src="../products/Comfort of Bereaved.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Comfort of Bereaved</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱5,000</span> & Shipping Fee</div>
                        <div class="description">
                        Composed of paper Lisianthus, Roses, Sunflower, Carnation, Malaysian Mums flowers.
                        </div>
