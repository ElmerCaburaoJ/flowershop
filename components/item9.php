...
<body>
    ...
    <main>
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="9">
                    <div class="img-con">
                        <img src="../products/Finesse.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Excellence</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">600</span> & Shipping Fee</div>
