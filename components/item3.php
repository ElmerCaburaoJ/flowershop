        ...
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="3">
                    <div class="img-con">
                        <img src="../products/charm.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Charm</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱500</span> & Shipping Fee</div>
                        <div class="description">
                        Composed of Carnation (2pcs), Alstroemeria (6pcs)
                        </div>
