...
<body>
    ...
    <main>
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="17">
                    <div class="img-con">
                        <img src="../products/Sincerity.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Sincerity</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱3,000</span> & Shipping Fee</div>
