        ...
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="4">
                    <div class="img-con">
                        <img src="../products/clarity.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Clarity</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱900</span> & Shipping Fee</div>
                        <div class="description">
                        Composed of 1 Sunflower and Yellow Malaysian Mum flowers
                        </div>
