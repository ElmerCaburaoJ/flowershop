...
<body>
    ...
    <main>
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="19">
                    <div class="img-con">
                        <img src="../products/Beautiful Farewell.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Beautiful Farewell</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱2,500</span> & Shipping Fee</div>
