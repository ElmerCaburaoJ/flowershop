...
<body>
    ...
    <main>
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="10">
                    <div class="img-con">
                        <img src="../products/Flourish.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Flourish</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱1,500</span> & Shipping Fee</div>
