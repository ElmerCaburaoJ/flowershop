...
<body>
    ...
    <main>
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="18">
                    <div class="img-con">
                        <img src="../products/A life remembered.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">A life remembered</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱2,000</span> & Shipping Fee</div>
