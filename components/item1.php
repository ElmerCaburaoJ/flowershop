        ...
        <div class="center">
            <div class="div">
                <div class="item-con grid" id="1">
                    <div class="img-con">
                        <img src="../products/beaming.png" alt="">
                    </div>
                    <div class="right-con">
                        <h1 class="name-js">Beaming</h1>
                        <div class="type">Availability: On Stock</div>
                        <div class="price-div"><span class="price">₱1,400</span> & Shipping Fee</div>
                        <div class="description">
                        Composed of Sunflowers (3pcs)
                        </div>
